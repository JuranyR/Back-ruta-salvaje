...
public class PlanRequestDTO {
    ...
    public PlanRequestDTO(String nombre, String descripcion, Double precio, Double descuentoPorcentaje, TipoPlan tipoPlan, Dificultad dificultad, Boolean estado, String actividades, String imagen) {
        this.nombre = nombre;
