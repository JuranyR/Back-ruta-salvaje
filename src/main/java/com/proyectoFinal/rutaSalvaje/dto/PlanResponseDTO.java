...
public class PlanResponseDTO {
    ...
    public PlanResponseDTO(Long id, String nombre, String descripcion, Double precio, Double descuentoPorcentaje, Double precioFinal, TipoPlan tipoPlan, Dificultad dificultad, Boolean estado, String actividades, String imagen, List<ResenaResponseDTO> resenas) {
        this.id = id;
        this.nombre = nombre;
